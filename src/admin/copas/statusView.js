...
import {
  normalizarPartidosParaBracket as _normalizarPartidosParaBracket,
  normalizarCrucesParaBracket as _normalizarCrucesParaBracket,
  renderBracket as _renderBracket
} from '../../utils/bracketRenderer.js';
  ...
  return `
    <div class="copa-seccion" data-esquema-id="${_esc(esq.id)}"
      ...
      <div class="cruces-container" data-esquema-id="${_esc(esq.id)}">
        ${_renderBracket(bracketData, { showConfirmButton: true })}
        ${progressHtml}
...
function _renderEsquemaEnCurso(esq, copa, partidos) {
  ...
  return `
    <div class="copa-seccion" data-esquema-id="${esq.id}"
      ...
      ${_renderBracket(_normalizarPartidosParaBracket(partidos), { showConfirmButton: true })}
      ${autoFinalHint}
    </div>
  `;
}
