...
-- PRIMARY KEY ya debería existir si la tabla fue creada con CREATE TABLE IF NOT EXISTS
-- Si la tabla no existe, CREATE TABLE ya crea la PK. Si existe, esta línea fallará pero es seguro ignorar.
-- ALTER TABLE ONLY "public"."copas" ADD CONSTRAINT "copas_pkey" PRIMARY KEY ("id");



-- PRIMARY KEY ya debería existir si la tabla fue creada con CREATE TABLE IF NOT EXISTS
-- Si la tabla no existe, CREATE TABLE ya crea la PK. Si existe, esta línea fallará pero es seguro ignorar.
-- ALTER TABLE ONLY "public"."grupos" ADD CONSTRAINT "grupos_pkey" PRIMARY KEY ("id");



-- PRIMARY KEY ya debería existir si la tabla fue creada con CREATE TABLE IF NOT EXISTS
-- Si la tabla no existe, CREATE TABLE ya crea la PK. Si existe, esta línea fallará pero es seguro ignorar.
-- ALTER TABLE ONLY "public"."parejas" ADD CONSTRAINT "parejas_pkey" PRIMARY KEY ("id");
...
-- PRIMARY KEY ya debería existir si la tabla fue creada con CREATE TABLE IF NOT EXISTS
-- Si la tabla no existe, CREATE TABLE ya crea la PK. Si existe, esta línea fallará pero es seguro ignorar.
-- ALTER TABLE ONLY "public"."posiciones_manual" ADD CONSTRAINT "posiciones_manual_pkey" PRIMARY KEY ("id");



-- Eliminar constraint UNIQUE si existe antes de crearlo
ALTER TABLE ONLY "public"."posiciones_manual" DROP CONSTRAINT IF EXISTS "posiciones_manual_torneo_id_grupo_id_pareja_id_key";
ALTER TABLE ONLY "public"."posiciones_manual" ADD CONSTRAINT "posiciones_manual_torneo_id_grupo_id_pareja_id_key" UNIQUE ("torneo_id", "grupo_id", "pareja_id");
...
-- PRIMARY KEY ya debería existir si la tabla fue creada con CREATE TABLE IF NOT EXISTS
-- Si la tabla no existe, CREATE TABLE ya crea la PK. Si existe, esta línea fallará pero es seguro ignorar.
-- ALTER TABLE ONLY "public"."tracking_eventos" ADD CONSTRAINT "tracking_eventos_pkey" PRIMARY KEY ("id");



-- Eliminar índice si existe antes de crearlo
DROP INDEX IF EXISTS "public"."idx_grupos_torneo";
CREATE INDEX "idx_grupos_torneo" ON "public"."grupos" USING "btree" ("torneo_id");



-- Eliminar índice si existe antes de crearlo
DROP INDEX IF EXISTS "public"."idx_parejas_copa_asignada";
CREATE INDEX "idx_parejas_copa_asignada" ON "public"."parejas" USING "btree" ("copa_asignada_id");



-- Eliminar índice si existe antes de crearlo
DROP INDEX IF EXISTS "public"."idx_parejas_torneo";
CREATE INDEX "idx_parejas_torneo" ON "public"."parejas" USING "btree" ("torneo_id");



-- Eliminar índice si existe antes de crearlo
DROP INDEX IF EXISTS "public"."idx_partidos_cargado_por";
CREATE INDEX "idx_partidos_cargado_por" ON "public"."partidos" USING "btree" ("cargado_por_pareja_id");



-- Eliminar índice si existe antes de crearlo
DROP INDEX IF EXISTS "public"."idx_partidos_copa";
CREATE INDEX "idx_partidos_copa" ON "public"."partidos" USING "btree" ("copa_id");



-- Eliminar índice si existe antes de crearlo
DROP INDEX IF EXISTS "public"."idx_partidos_copa_orden";
...
ALTER TABLE ONLY "public"."copas" DROP CONSTRAINT IF EXISTS "copas_torneo_id_fkey";
ALTER TABLE ONLY "public"."copas" ADD CONSTRAINT "copas_torneo_id_fkey" FOREIGN KEY ("torneo_id") REFERENCES "public"."torneos"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."grupos" DROP CONSTRAINT IF EXISTS "grupos_torneo_id_fkey";
ALTER TABLE ONLY "public"."grupos" ADD CONSTRAINT "grupos_torneo_id_fkey" FOREIGN KEY ("torneo_id") REFERENCES "public"."torneos"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."parejas" DROP CONSTRAINT IF EXISTS "parejas_copa_asignada_id_fkey";
ALTER TABLE ONLY "public"."parejas" ADD CONSTRAINT "parejas_copa_asignada_id_fkey" FOREIGN KEY ("copa_asignada_id") REFERENCES "public"."copas"("id") ON DELETE SET NULL;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."parejas" DROP CONSTRAINT IF EXISTS "parejas_torneo_id_fkey";
ALTER TABLE ONLY "public"."parejas" ADD CONSTRAINT "parejas_torneo_id_fkey" FOREIGN KEY ("torneo_id") REFERENCES "public"."torneos"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."partidos" DROP CONSTRAINT IF EXISTS "partidos_cargado_por_pareja_id_fkey";
ALTER TABLE ONLY "public"."partidos" ADD CONSTRAINT "partidos_cargado_por_pareja_id_fkey" FOREIGN KEY ("cargado_por_pareja_id") REFERENCES "public"."parejas"("id");



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."partidos" DROP CONSTRAINT IF EXISTS "partidos_copa_id_fkey";
ALTER TABLE ONLY "public"."partidos" ADD CONSTRAINT "partidos_copa_id_fkey" FOREIGN KEY ("copa_id") REFERENCES "public"."copas"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."partidos" DROP CONSTRAINT IF EXISTS "partidos_grupo_id_fkey";
ALTER TABLE ONLY "public"."partidos" ADD CONSTRAINT "partidos_grupo_id_fkey" FOREIGN KEY ("grupo_id") REFERENCES "public"."grupos"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."partidos" DROP CONSTRAINT IF EXISTS "partidos_pareja_a_id_fkey";
ALTER TABLE ONLY "public"."partidos" ADD CONSTRAINT "partidos_pareja_a_id_fkey" FOREIGN KEY ("pareja_a_id") REFERENCES "public"."parejas"("id");



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."partidos" DROP CONSTRAINT IF EXISTS "partidos_pareja_b_id_fkey";
ALTER TABLE ONLY "public"."partidos" ADD CONSTRAINT "partidos_pareja_b_id_fkey" FOREIGN KEY ("pareja_b_id") REFERENCES "public"."parejas"("id");



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."partidos" DROP CONSTRAINT IF EXISTS "partidos_torneo_id_fkey";
ALTER TABLE ONLY "public"."partidos" ADD CONSTRAINT "partidos_torneo_id_fkey" FOREIGN KEY ("torneo_id") REFERENCES "public"."torneos"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."posiciones_manual" DROP CONSTRAINT IF EXISTS "posiciones_manual_grupo_id_fkey";
ALTER TABLE ONLY "public"."posiciones_manual" ADD CONSTRAINT "posiciones_manual_grupo_id_fkey" FOREIGN KEY ("grupo_id") REFERENCES "public"."grupos"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."posiciones_manual" DROP CONSTRAINT IF EXISTS "posiciones_manual_pareja_id_fkey";
ALTER TABLE ONLY "public"."posiciones_manual" ADD CONSTRAINT "posiciones_manual_pareja_id_fkey" FOREIGN KEY ("pareja_id") REFERENCES "public"."parejas"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."posiciones_manual" DROP CONSTRAINT IF EXISTS "posiciones_manual_torneo_id_fkey";
ALTER TABLE ONLY "public"."posiciones_manual" ADD CONSTRAINT "posiciones_manual_torneo_id_fkey" FOREIGN KEY ("torneo_id") REFERENCES "public"."torneos"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."tracking_eventos" DROP CONSTRAINT IF EXISTS "tracking_eventos_pareja_id_fkey";
ALTER TABLE ONLY "public"."tracking_eventos" ADD CONSTRAINT "tracking_eventos_pareja_id_fkey" FOREIGN KEY ("pareja_id") REFERENCES "public"."parejas"("id") ON DELETE CASCADE;



-- Eliminar constraint si existe antes de crearlo
ALTER TABLE ONLY "public"."tracking_eventos" DROP CONSTRAINT IF EXISTS "tracking_eventos_torneo_id_fkey";
ALTER TABLE ONLY "public"."tracking_eventos" ADD CONSTRAINT "tracking_eventos_torneo_id_fkey" FOREIGN KEY ("torneo_id") REFERENCES "public"."torneos"("id") ON DELETE CASCADE;
...
INSERT INTO "public"."torneos" ("id", "nombre", "iniciado", "created_at") VALUES
	('ad58a855-fa74-4c2e-825e-32c20f972136', 'Torneo Miércoles', false, '2026-01-10 05:00:37.891404+00') ON CONFLICT DO NOTHING;
...
INSERT INTO "public"."copas" ("id", "torneo_id", "nombre", "orden", "created_at") VALUES
	...
	('dbc0354a-e3a2-4459-afea-27af7054c927', 'ad58a855-fa74-4c2e-825e-32c20f972136', '¿El auto tiene ISOFIX?', 5, '2026-01-21 16:04:43.96589+00') ON CONFLICT DO NOTHING;
...
INSERT INTO "public"."grupos" ("id", "torneo_id", "nombre") VALUES
	...
	('0d18b572-140d-4157-b0cc-df929420cdb6', 'ad58a855-fa74-4c2e-825e-32c20f972136', 'Realidad') ON CONFLICT DO NOTHING;
...
INSERT INTO "public"."parejas" ("id", "torneo_id", "nombre", "orden", "created_at", "copa_asignada_id") VALUES
	...
	('22171e29-a328-43c8-9d9d-773949767fa1', 'ad58a855-fa74-4c2e-825e-32c20f972136', 'Alan - Tammy', 2, '2026-01-20 20:27:33.516296+00', NULL) ON CONFLICT DO NOTHING;
...
INSERT INTO "public"."partidos" ("id", "torneo_id", "grupo_id", "pareja_a_id", "pareja_b_id", "games_a", "games_b", "updated_at", "copa_id", "ronda_copa", "orden_copa", "estado", "cargado_por_pareja_id", "resultado_temp_a", "resultado_temp_b", "notas_revision", "ronda") VALUES
	...
	('858666fe-bc70-4243-b1da-ed91c8a3cb54', 'ad58a855-fa74-4c2e-825e-32c20f972136', '53bc7af8-d65e-47eb-97a4-e0fcf9e65c42', '22171e29-a328-43c8-9d9d-773949767fa1', 'f1373f49-9128-43e1-bebd-d8b722fc21a6', 5, 2, '2026-01-22 00:35:35.929+00', NULL, NULL, NULL, 'confirmado', 'f1373f49-9128-43e1-bebd-d8b722fc21a6', NULL, NULL, NULL, 3) ON CONFLICT DO NOTHING;
...
INSERT INTO "public"."tracking_eventos" ("id", "torneo_id", "pareja_id", "jugador_nombre", "tipo_evento", "metadata", "created_at") VALUES
	...
	('43f2f8ac-0e7e-4822-aa3f-b55d4f199dc8', 'ad58a855-fa74-4c2e-825e-32c20f972136', 'f1373f49-9128-43e1-bebd-d8b722fc21a6', 'Tincho', 'visita', '{"grupo": "Expectativa", "companero": "Lau", "timestamp": "2026-01-23T03:55:10.833Z", "pareja_nombre": "Tincho - Lau"}', '2026-01-23 03:55:11.306818+00') ON CONFLICT DO NOTHING;
